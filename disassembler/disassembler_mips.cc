...
static const MipsInstruction gMipsInstructions[] = {
  ...
  { kMsaMask | (0x7 << 23), kMsa | (0x0 << 23) | 0x11, "subs_s", "Vkmn" },
  { kMsaMask | (0x7 << 23), kMsa | (0x1 << 23) | 0x11, "subs_u", "Vkmn" },
  ...
  { kMsaMask | (0x7 << 23), kMsa | (0x2 << 23) | 0x10, "adds_s", "Vkmn" },
  { kMsaMask | (0x7 << 23), kMsa | (0x3 << 23) | 0x10, "adds_u", "Vkmn" },
